...
| 6 — Manual testing | [phase-6-manual-testing.md](phase-6-manual-testing.md) | 🟡 In progress | Checklist to run by hand as donor and admin; record problems in the Phase 7 Findings table. Automated cycles done (6a); manual pass pending. |
...
| 7 — Bug fixing | [phase-7-bug-fixing.md](phase-7-bug-fixing.md) | ⬜ Planned | Fix what Phase 6/6a found, by severity. Findings table lives in this doc. |
